...
def myNetwork():
    ...
    sta2 = net.addStation('sta2', ip='172.16.2.202',
                           position='386.0,459.0,0')
    sta4 = net.addStation('sta4', ip='172.16.2.204',
                           position='433.0,190.0,0')
    sta5 = net.addStation('sta5', ip='172.16.2.205',
                           position='435.0,76.0,0')
    sta3 = net.addStation('sta3', ip='172.16.4.203',
                           position='590.0,432.0,0')
    h1 = net.addHost('h1', cls=Host, ip='172.16.0.1', defaultRoute=None)
    sta1 = net.addStation('sta1', ip='172.16.2.201',
    ...
    net.build()
    net.addNAT(name = 'nat1',LinkTo = 'ap1',ip = '172.16.2.61').configDefault()
    net.addNAT(name = 'nat2',LinkTo = 'ap2',ip = '172.16.2.62').configDefault()
    net.addNAT(name = 'nat3',LinkTo = 'ap3',ip = '172.16.2.63').configDefault()
    net.addNAT(name = 'nat4',LinkTo = 'ap4',ip = '172.16.4.41').configDefault()
